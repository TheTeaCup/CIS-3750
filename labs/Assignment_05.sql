...
-- task 2 INSERT VALUE INTO TABLE REP
INSERT INTO REP VALUES ('35', 'Fred', 'Kiser', '427 Billings Dr.', 'Cody', 'WY', '82414', '307-555-6309', 0.00, 0.05);

-- VIEW INSETED VALUE INTO TABLE REP
SELECT * FROM REP;

-- TASK 3 DELETE TABLE REP
DROP TABLE REP;
